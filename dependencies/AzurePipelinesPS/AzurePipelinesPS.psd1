...
FunctionsToExport = 'Add-APDeploymentGroup', 'Add-APField', 'Add-APGroupMembership', 
               ...
               'Get-APWidget', 'Get-APWidgetList', 'Get-APWorkItem', 
               'Get-APWorkItemList', 'Get-APWorkItemTypeCategoriesList', 
               'Get-APWorkItemTypeList', 'Install-APAgent', 'Install-APPSModule', 
